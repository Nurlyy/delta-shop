...
<section class="py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6">
                <?= Html::img(isset($images[$product->product_id]) ? "http://backend.test.localhost:8080/uploads/{$images[$product->product_id]->path}" : "https://dummyimage.com/600x700/dee2e6/6c757d.jpg", ['class' => 'card-img-top mb-5 mb-md-0']) ?>
            </div>
            <div class="col-md-6">
                ...
                <?php foreach ($products as $p) { ?>
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <?= Html::img(isset($images[$p->product_id]) ? "http://backend.test.localhost:8080/uploads/{$images[$p->product_id]->path}" : "https://dummyimage.com/450x300/dee2e6/6c757d.jpg", ['class' => 'card-img-top']) ?>
                            <!-- Product details-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="/product/<?= $p->product_id ?>">View options</a></div>
                            </div>
                        </div>
                    </div>
                <?php } ?>
